...
func (c *fileServiceClient) ReportFile(ctx context.Context, in *ReportFileRequest, opts ...grpc.CallOption) (*ReportFileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportFileResponse)
	err := c.cc.Invoke(ctx, FileService_ReportFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServiceServer) ReportFile(context.Context, *ReportFileRequest) (*ReportFileResponse, error) {
...
func _FileService_ReportFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).ReportFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_ReportFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).ReportFile(ctx, req.(*ReportFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FileService_ReportFile_Handler,
		},
	},
